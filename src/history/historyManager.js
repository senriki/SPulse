...
function _snapshot(vs) {
  return {
    ...
    barGap:           vs.barGap,
    numBars:          vs.numBars,
    mirrorLR:         vs.mirrorLR,
    mirrorPeakCenter: vs.mirrorPeakCenter,
    ...
    yOffset:          vs.yOffset,
    channelMode:              vs.channelMode,
    stereoLayout:             vs.stereoLayout,
    independentChannelColors: vs.independentChannelColors,
    colorL:                   vs.colorL,
    colorR:                   vs.colorR,
    background: {
